    ...
    <div className="illustration-editor">
      <div className="code-blocks">
        ...
        <div className="code code-html">
          ...
          <div className="code-content mx-3">
            <code>
              <p className="html-line-1">
                <span className="c-a">&lt;button </span>
                <span className="c-p">type</span><span className="c-w">=</span><span className="c-a">"button" </span>
                <span className="c-p">class</span><span className="c-w">=</span><span className="c-a">"liquid"</span>
                <span className="c-a">&gt;</span><br/>
              </p>
              <p className="html-line-2">
                <span className="c-w">Download my CV</span>
              </p><br/>
              <p className="html-line-3">
                <span className="c-a">&lt;/button&gt;</span>
              </p>
            </code>
          </div>
        ...
        <div className="code code-css">
          ...
          <div className="code-content mx-3">
            <code>
              <p className="line-1">
                <span className="c-a">.liquid:hover</span> <span className="c-w">&#123;</span>
              </p><br/>
              <p className="line-2">
                <span className="c-p">--p</span><span className="c-w">:</span> <span className="c-w">100%</span><span className="c-w">;</span>
              </p><br/> 
              <p className="line-3">
                <span className="c-p">--t</span><span className="c-w">:</span> <span className="c-w">0.3s</span><span className="c-w">;</span>
              </p><br/>
              <p className="line-4">
                <span className="c-p">color</span><span className="c-w">:</span>
              </p><br/>
              <p className="line-5">
                &nbsp; <span className="c-p">var</span><span className="c-w">&#40;</span><span className="c-a">--color-base-300</span><span className="c-w">&#41;</span><span className="c-w">;</span> <span className="c-w">&#125;</span>
              </p>
            </code>
          </div>
        </div>
        ...
        <div className="code code-js">
          ...
          <div className="code-content mx-3">
            <code>
              <p className="js-line-1">
                <span className="c-p">const </span>
                <span className="c-p">btn </span>
                <span className="c-w">= </span>
                <span className="c-w">document.</span>
                <span className="c-a">querySelector</span>
              </p><br/>
              <p className="js-line-2">
                <span className="c-w">(</span>
                <span className="c-a">'.liquid'</span>
                <span className="c-w">);</span><br/>
              </p><br/>
              <p className="js-line-3">
                <span className="c-p">function </span><span className="c-p">triggerDownload</span><span className="c-w">() </span><span className="c-w">&#123;</span><br/>
              </p><br/>
              <p className="js-line-4">
                <span className="c-w">// Logic here</span><br/>
              </p><br/>
              <p className="js-line-5">
                <span className="c-w">&#125;</span>
              </p><br/>
            </code>
          </div>
