...
// This is the HTML block from the CodePen, wrapped in a React component.
          ...
          <div className="code-content">
            <code>
              <p className="js-line-1">
                <span className="c-p">const </span><span className="c-p">btn </span><span className="c-w">= </span><span className="c-w">document.</span><span className="c-a">querySelector</span><span className="c-w">(</span><span className="c-a">'.liquid'</span><span className="c-w">);</span>
              </p><br/>

              <p className="js-line-2">
                <span className="c-p">function </span><span className="c-p">triggerDownload</span><span className="c-w">() </span><span className="c-w">&#123;</span>
              </p>

              <p className="js-line-3">
                <span className="c-w">// Logic here</span>
              </p>
